...
function AdminDashboard() {
  ...
  return <main className={styles.page}>
    ...
    {tab === "overview" && <Operations sessions={monthRules} values={collectedAmounts} setValues={setCollectedAmounts} closeSession={closeSession} expectedAmount={expectedAmount} />}
...
function Operations({ sessions, values, setValues, closeSession, expectedAmount }: { sessions: Session[]; values: Record<string, string>; setValues: (value: Record<string, string>) => void; closeSession: (session: Session) => void; expectedAmount: (session: Session) => number }) {
