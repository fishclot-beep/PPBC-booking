...
type Session = { id: string; title: string; starts_at: string; ends_at: string; capacity: number; price_type: "private" | "per_person"; price_amount: number; booked_seats: number; actual_collected: number | null; closed_at: string | null; closed_by_name?: string | null };
